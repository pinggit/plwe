...
array set params [::cmdline::getKnownOptions argv $options $usage]

if {  $params(a) } { set set_atime "true"; puts "set_atime is $set_atime" }
set has_t [expr {$params(t) != -1}]
set has_r [expr {[string length $params(r)] > 0}]
puts "params_r is $params(r);has_r is $has_r"
if {$has_t && $has_r} {
