...
proc sendanemail {caseid file emailto {emailcc "pings@cisco.net"}} {
...
proc repeat_pags {maxrounds pags host pattern_timeout pa_intv pags_intv} {
...
#
    ...
    the intention is to help tac day-to-day work. But it can also be used for ANY other usual tasks 
