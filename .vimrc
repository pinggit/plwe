...
"
"F5 		insert a timestamp under insert mode
"
...
",ag 		line-through 
",ah 		normal: asciidoc (whole ) to html , and call browser
...
",ap 		asciidoc to pdf (not done yet)
"               [v]ArchiveNotDone
",aP 		asciidoc to pdf
",aq 		qanda
...
"
"#########text object (operator-pending map) {{{2
